...
class Proxy
  # creates the instance variable messages
  # and gives us nice methods to interact with
  ...
  # check if it is included in the messages
  def called?(method_name)
    @messages.include? method_name
  end

  # Count the occurrences of a method name
  def number_of_times_called(method_name)
    @messages.count method_name
  end

  def method_missing(method_name, *args, &block)
    # If the target object can respond to this method, track it
    if @object.respond_to? method_name
      # Track the method like this
      @messages.push method_name
      # Call the method like this
      @object.send method_name, *args
    else
      # In other cases, default behaviour is what we want
